...
// also blatantly stolen from create
public class Couple<T> extends Pair<T, T> implements Iterable<T> {

	public static final Couple<Boolean> TRUE_AND_FALSE = new Couple<>(true, false) {
		@Override
	...
	public static <T> Couple<T> create(Supplier<T> factory) {
		return create(factory.get(), factory.get());
	}
