...
pub fn part1(input: []const u8) !usize {
    ...
    var firstCol = ArrayList(usize).init(lib.allocator);
    var secondCol = ArrayList(usize).init(lib.allocator);
    ...
    while (lines.next()) |line| {
        ...
        try firstCol.append(try lib.parseInt(split.next().?));
        try secondCol.append(try lib.parseInt(split.next().?));
        numLines += 1;
    }
